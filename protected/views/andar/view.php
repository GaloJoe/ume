...
<h2><?php echo GxHtml::encode($model->getRelationLabel('apartamentos')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->apartamentos as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('apartamento/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
