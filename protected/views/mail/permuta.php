...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        ...
        <div class="container" id="page">
            ...
            <p>
                O apartamento <b><?php echo $numeroAp; ?></b> do bloco <b><?php echo $bloco; ?></b> foi permutado.
            </p>
            
            <p>
                Seguem os dados do corretor para quem a permuta foi efetuada: <br/>
            ...
            <p>
                Data e hora da permuta: <b><?php echo $data; ?>. </b><br/>
            </p>
