...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        ...
        <div class="container" id="page">
            ...
            <p>
                Uma nova reserva foi feita para o apartamento <b><?php echo $numeroAp; ?></b> do bloco <b><?php echo $bloco; ?></b>.
            </p>
            
            <p>
                Seguem os dados do corretor que efetuou a reserva: <br/>
            ...
            <p>
                Data e hora da reserva: <b><?php echo $data; ?>. </b><br/>
                Esta reserva expira em <b><?php echo $diasReserva; ?> dia(s)</b>.
            </p>
