...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        ...
        <div class="container" id="page">
            ...
            <p>
                O apartamento <b><?php echo $numeroAp; ?></b> do bloco <b><?php echo $bloco; ?></b> foi vendido.
            </p>
            
            <p>
                Seguem os dados do corretor para quem a venda foi efetuada: <br/>
            ...
            <p>
                Data e hora da venda: <b><?php echo $data; ?>. </b><br/>
            </p>
            ...
            <p>
                ...
                Comissão a pagar ao corretor: <b><?php echo $valorComissaoCorretor; ?></b><br/>
                Comissão a pagar ao Adm. de Vendas: <b><?php echo $valorComissaoAdmVendas; ?></b>
            </p>
